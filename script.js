...
function submitNewBook() {
  ...
  if (title && author && numPages && !isNaN(numPages)) {
    ...
    alert(
      "Invalid submission: Please fill out all portions of the form correctly"
    );
  }
}
...
function remove(e) {
  ...
  if (
    confirm(
      "Are you sure you want to delete the entry for: " + myLibrary[index].title
    )
  ) {
...
document
  .querySelector("#new-entry-form-close")
  .addEventListener("click", changeNewEntryState);
render();
